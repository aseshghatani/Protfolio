...
function Navbar() {
  ...
  return (
    <>
      <nav className="w-full  fixed top-0 left-0 shadow-sm border-1 border-gray-600 z-50 bg-white/30 backdrop-blur-sm">
        <div className="w-full relative flex justify-center items-center">
          ...
          />
          <div className="w-full md:w-[85%] flex py-4 px-4 justify-between items-center">
